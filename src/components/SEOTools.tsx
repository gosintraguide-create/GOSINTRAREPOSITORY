      ...
      <TabsContent value="tools" className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage SEO assets for your website including
        ...
        <Card className="p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Generate and download your website's sitemap for
              search engines.
            </p>
          </div>
        ...
        <Card className="p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Blocks admin and internal pages while allowing all
              public content.
            </p>
          </div>
        ...
        <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5 p-6">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                All blog articles have unique meta titles and
                descriptions
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-500">✓</span>
              <span>
                Structured data (JSON-LD) for articles with
                Article schema
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-500">✓</span>
              <span>
                Open Graph and Twitter Card tags for social
                sharing
              </span>
            </li>
            <li className="flex items-start gap-2">
          ...
          <ol className="space-y-3 text-sm">
            ...
            <li className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-muted-foreground">
                  Place both files in the /public directory of
                  your website
                </span>
              </div>
            </li>
            <li className="flex gap-3">
              ...
              <div>
                ...
                <span className="text-muted-foreground">
                  Visit search.google.com/search-console and
            ...
            <li className="flex gap-3">
              ...
              <div>
                <strong className="block">
                  Update sitemap when adding articles
                </strong>
                <span className="text-muted-foreground">
                  Regenerate and reupload your sitemap after
