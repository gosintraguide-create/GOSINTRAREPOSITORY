...
export function AttractionsPage({ onNavigate, language = "en" }: AttractionsPageProps) {
  ...
  const attractions = Object.entries(content.attractions.attractionDetails).map(([id, attr]) => ({
    id,
    name: attr.name,
              ...
              >
                ...
                >
                  ...
                  <div className="relative aspect-[16/10] overflow-hidden">
                    <ImageWithFallback
                      src={attraction.cardImage || attractionFallbackImages[attraction.id] || "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=800&h=600&fit=crop"}
                      alt={attraction.name}
