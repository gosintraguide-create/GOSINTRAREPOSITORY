...
export const en: WebsiteContent = {
  ...
  routes: {
    ...
    subtitle: "All stops served every 30 minutes • No need to change vehicles",
    route1: "Route 1",
    route2: "Route 2",
    bothRoutes: "Both routes",
    loopsBack: "loops back",
    onePassBothRoutes: "One Pass, Both Routes",
    onePassDescription: "Your day pass gives you unlimited access to both routes. Our vehicles visit all stops every 30 minutes from 9 AM to 7 PM, and you never need to change vehicles - stay on board as routes connect at Train Station and Historical Center North.",
    stops: {
