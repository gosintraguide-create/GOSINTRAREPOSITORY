...
export const componentTranslations: { [key: string]: ComponentTranslations } = {
  en: {
    ...
    aboutPage: {
      ...
      messageError: "Unable to send message. Please try WhatsApp or email us directly at hoponsintra@gmail.com",
      fullName: "Full Name",
      emailAddress: "Email Address",
    },
  ...
  pt: {
    ...
    aboutPage: {
      ...
      messageError: "Não foi possível enviar a mensagem. Por favor, use WhatsApp ou envie e-mail para hoponsintra@gmail.com",
      fullName: "Nome Completo",
      emailAddress: "Endereço de E-mail",
    },
  ...
  es: {
    ...
    aboutPage: {
      ...
      messageError: "No se pudo enviar el mensaje. Por favor, usa WhatsApp o envía un correo a hoponsintra@gmail.com",
      fullName: "Nombre Completo",
  ...
  fr: {
    ...
    aboutPage: {
      ...
      messageError: "Impossible d'envoyer le message. Veuillez utiliser WhatsApp ou nous envoyer un e-mail à hoponsintra@gmail.com",
      fullName: "Nom Complet",
      emailAddress: "Adresse E-mail",
    },
  ...
  de: {
    ...
    aboutPage: {
      ...
      messageError: "Nachricht konnte nicht gesendet werden. Bitte verwenden Sie WhatsApp oder senden Sie uns eine E-Mail an hoponsintra@gmail.com",
      fullName: "Vollständiger Name",
      emailAddress: "E-Mail-Adresse",
    },
  ...
  nl: {
    ...
    aboutPage: {
      ...
      messageError: "Kan bericht niet verzenden. Gebruik WhatsApp of e-mail ons rechtstreeks op hoponsintra@gmail.com",
      fullName: "Volledige Naam",
      emailAddress: "E-mailadres",
    },
  ...
  it: {
    ...
    aboutPage: {
      ...
      messageError: "Impossibile inviare il messaggio. Usa WhatsApp o inviaci un'email a hoponsintra@gmail.com",
      fullName: "Nome Completo",
      emailAddress: "Indirizzo Email",
    },
