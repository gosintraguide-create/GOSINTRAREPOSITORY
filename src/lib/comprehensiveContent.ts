...
export const DEFAULT_COMPREHENSIVE_CONTENT: ComprehensiveContent = {
  ...
  seo: {
    ...
    hopOnService: {
      ...
      description: "Get unlimited hop-on/hop-off access from 9am to 7pm with guaranteed seating in tuk-tuks and UMM jeeps. Explore Sintra's palaces and castles at your own pace.",
