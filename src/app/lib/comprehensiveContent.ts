...
export const DEFAULT_COMPREHENSIVE_CONTENT: ComprehensiveContent = {
  ...
  homepage: {
    hero: {
      ...
      subtitle: "Hop-on, hop-off day pass with guaranteed seats. Unlimited rides in small tuk tuks and vintage jeeps.",
      ctaButton: "Book Your Day Pass",
      benefitPills: [
        { icon: "Users", text: "Small Groups (2-6)" },
        { icon: "Clock", text: "All Day Service" },
    ...
    features: [
      ...
      },
      {
        ...
        description: "Hop off at any attraction, explore at your own pace, then catch the next ride. Your schedule, your adventure.",
        icon: "RefreshCw",
      },
      {
      ...
      },
      {
        ...
        description: "Consistent service throughout the day. No rigid schedules — just show up at any stop.",
        icon: "Calendar",
      },
      {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Show your QR code to board at any stop. Consistent service all day means you're always moments away from discovering Sintra's next treasure.",
      },
    ],
    whatMakesUsSpecial: {
      ...
      features: [
        ...
        },
        {
          ...
          description: "Consistent service from 9 AM to 8 PM. Never feel rushed. Total flexibility.",
          icon: "Clock",
        },
        {
    ...
    frequentlyAskedQuestions: {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "We maintain consistent service throughout operating hours. You'll never wait long to catch your next ride to a different attraction.",
        },
        {
  ...
  attractions: {
    ...
    attractionDetails: {
      ...
      "convento-capuchos": {
        ...
        shortDescription: "A serene 16th-century Franciscan monastery built into natural rock formations, offering a unique glimpse into monastic life of simplicity and communion with nature.",
        longDescription: "The Convent of the Capuchin Friars was founded in 1560 and is one of the most remarkable examples of monastic architecture in Portugal. Built directly into massive boulders and cork trees, the convent embodies the Franciscan ideals of poverty and harmony with nature. The tiny cells, low doorways, and cork-lined walls create an atmosphere of profound tranquility and humility. Abandoned in 1834, the convent has been preserved as a monument to simple living.",
        highlights: [
          "Unique architecture integrated with natural rock",
          "Cork-lined walls and ceilings throughout",
          "Peaceful forest setting away from crowds",
          "Tiny monks' cells carved into boulders",
          "Stunning views over the Sintra mountains",
        ],
        hours: "9:30 AM - 6:00 PM (Last entry 5:00 PM)",
        duration: "1-1.5 hours recommended",
        tips: [
          "Be prepared for low doorways - watch your head!",
      ...
      "cabo-da-roca": {
        name: "Cabo da Roca",
        shortDescription: "The westernmost point of mainland Europe, where dramatic cliffs meet the Atlantic Ocean. Experience breathtaking coastal views and stand at the edge of the continent.",
        longDescription: "Cabo da Roca is located at latitude 38º 47' north and longitude 9º 30' west, marking the westernmost extent of the European mainland. The cape features a lighthouse built in 1772 and offers spectacular views of the Atlantic Ocean crashing against 140-meter-high cliffs. Portuguese poet Luís de Camões described it as 'where the land ends and the sea begins.' The dramatic landscape and powerful ocean create an unforgettable experience.",
        highlights: [
          "Westernmost point of continental Europe",
          "Dramatic 140-meter cliffs overlooking the Atlantic",
          "Historic lighthouse from 1772",
          "Certificate of visit available at gift shop",
          "Spectacular sunset views",
        ],
        hours: "Open 24 hours (Lighthouse and shop: 9:00 AM - 6:00 PM)",
        duration: "45 minutes - 1 hour recommended",
        tips: [
          "Can be very windy - bring a jacket",
          "Best visited at sunset for stunning photos",
      ...
      "villa-sassetti": {
        name: "Villa Sassetti",
        shortDescription: "An elegant Italian-style villa surrounded by romantic gardens, connected to the historic center by a scenic pedestrian trail through lush woodland.",
        longDescription: "Villa Sassetti was built in 1890 by Italian merchant Victor Carlos Sassetti, designed by Luigi Manini (the same architect behind Quinta da Regaleira). The villa showcases Italian architectural influences and sits within beautifully landscaped gardens featuring exotic trees, ornamental fountains, and romantic pathways. The property is connected to Sintra's historic center by a picturesque walking trail that winds through the forest, offering a peaceful escape from the busier attractions.",
        highlights: [
          "Elegant Italian-style architecture",
          "Beautiful romantic gardens and fountains",
          "Scenic forest trail to Sintra center",
          "Less crowded, peaceful atmosphere",
          "Stunning views of Moorish Castle",
        ],
        hours: "10:00 AM - 6:00 PM",
        duration: "1 hour recommended",
        tips: [
          "Free admission to the gardens",
          "Perfect spot for a peaceful walk",
          "Combine with the walking trail to town",
  ...
  about: {
    ...
    ourStory: {
      ...
      paragraphs: [
        ...
        "Today, thousands of visitors choose Hop On Sintra for guaranteed seating, reliable service throughout the day, and an authentic, intimate way to explore this magical destination.",
      ],
    },
    mission: {
      title: "Our Mission",
  ...
  seo: {
    ...
    home: {
      ...
      description: "Explore Sintra's UNESCO World Heritage sites with guaranteed seating in small vehicles. Unlimited rides all day. Book your flexible day pass online now.",
    ...
    about: {
      ...
      description: "Hop On Sintra offers premium hop-on/hop-off service with guaranteed seating in small vehicles. Consistent service throughout the day across Sintra.",
