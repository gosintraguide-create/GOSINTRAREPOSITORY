...
export function BlogEditor() {
  ...
  useEffect(() => {
    const loadData = async () => {
      setIsLoading(true);
      try {
        // Load from server to match BlogPage behavior
        const loadedArticles = await loadArticlesFromServer(
          projectId,
          publicAnonKey,
        );
        const loadedCategories = await loadCategoriesFromServer(
          projectId,
          publicAnonKey,
        );
  ...
  const updateCurrentTranslation = (
    updates: Partial<ArticleTranslation>,
  ) => {
  ...
  const handleSave = async () => {
    ...
    if (!editingArticle.slug) {
      editingArticle.slug = generateSlug(
        englishTranslation.title,
      );
    }

    // Calculate read time from English content
    editingArticle.readTimeMinutes = estimateReadTime(
      englishTranslation.content,
    );

    // Update last modified
    editingArticle.lastModified = new Date()
      .toISOString()
      .split("T")[0];
    ...
    if (!englishTranslation.seo.description) {
      englishTranslation.seo.description =
    ...
    // Save to server and clear cache for sync
  ...
  const handleResetToDefaults = () => {
    if (
      confirm(
        "This will reset all articles to the default set. Are you sure?",
      )
    ) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Create and manage travel guides and articles about
            Sintra
          </p>
        </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                      ...
                      <div>{article.tags.length} tags</div>
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <Button
      ...
      <Dialog open={isEditing} onOpenChange={setIsEditing}>
        <DialogContent className="max-h-[90vh] w-[95vw] max-w-[95vw] sm:max-w-[95vw] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
            ...
            (() => {
              ...
              return (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 rounded-lg border border-border p-4">
                    ...
                    <div className="space-y-4 rounded-lg border border-border p-4">
                      ...
                      <div>
                        ...
                        <Textarea
                          value={
                            currentTranslation.seo.description
                          }
                          onChange={(e) =>
                            updateCurrentTranslation({
                              seo: {
                      ...
                      <div>
                        ...
                        <Input
                          value={
                            currentTranslation.seo.keywords
                          }
                          onChange={(e) =>
                            updateCurrentTranslation({
                              seo: {
                  ...
                  <div className="space-y-4 rounded-lg border border-border p-4">
                    <h4 className="font-medium">
                      Article Metadata (applies to all
                      languages)
                    </h4>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <Label>
                          Featured Image URL (Legacy - Optional)
                        </Label>
                        <Input
                          value={
                  ...
                  <div>
                    ...
                    <p className="mb-2 text-sm text-muted-foreground">
                      Select tags from the predefined list for
                      ...
                      <div className="flex min-h-[60px] flex-wrap gap-2 rounded-md border border-border p-3">
                        {editingArticle.tags.length === 0 ? (
                          <p className="w-full text-center text-sm text-muted-foreground">
                            No tags selected. Search above to
                            add tags.
                          </p>
                        ) : (
