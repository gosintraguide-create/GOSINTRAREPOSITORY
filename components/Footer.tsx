...
export function Footer({
  ...
  return (
    <footer
      className="border-t border-border bg-gradient-to-b from-white to-secondary/30 py-10 sm:py-12 safe-bottom"
      role="contentinfo"
    >
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Your friendly hop-on/hop-off adventure through
              Sintra's magical landscapes.
            </p>
          </div>

          <div>
            <h3 className="mb-3 sm:mb-4 text-foreground text-base">
              {legacyContent.footer.quickLinks}
            </h3>
